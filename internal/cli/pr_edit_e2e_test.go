...
func TestE2EPREditArgv(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			want:     "gh pr edit 42 -R github.com/o/r --title t2 --body b2",
		},
		{
			...
			want:     "gh pr edit 42 -R github.com/o/r --body b2",
		},
		{
			...
			want:     "gh pr edit 42 -R github.com/custom/repo --title t",
		},
		{
			...
			want:     "glab mr update 42 --repo https://gitlab.com/o/r --title t --description b",
		},
		{
			...
			want:     "glab mr update 42 --repo https://gitlab.com/o/r --title t",
		},
		{
			...
			fakeName: "tea",
			args:     []string{"pr", "edit", "42", "--title", "t", "--body", "b"},
			want:     "tea pulls edit 42 --login pub --repo o/r --title t --description b",
		},
	}
