...
func TestE2EIssueDeleteArgv(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			want:     "gh issue delete 42 -R github.com/o/r",
		},
		{
			...
			want:     "gh issue delete 42 --yes -R github.com/o/r",
		},
		{
			name:     "gitlab delete",
			...
			fakeName: "glab",
			args:     []string{"issue", "delete", "42"},
			want:     "glab issue delete 42 --repo https://gitlab.com/o/r",
		},
		{
			...
			want:     "gh issue delete 42 --yes -R github.com/custom/repo",
		},
		{
			...
			want:     "glab issue delete 42 --repo https://gitlab.com/custom/repo",
		},
	}
