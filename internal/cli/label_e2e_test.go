...
func TestE2ELabelArgv(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			want:     wantCall("gh", "label", "list", "-R", "github.com/o/r"),
		},
		{
			...
			want:     wantCall("gh", "label", "list", "-R", "github.com/o/r", "--limit", "5"),
		},
		{
			...
			want:     wantCall("gh", "label", "create", "bug", "-R", "github.com/o/r", "--color", "ff0000", "--description", "버그"),
		},
		{
			...
			args:     []string{"label", "list"},
			want:     wantCall("glab", "label", "list", "--repo", "https://gitlab.com/o/r"),
		},
		{
			...
			want:     wantCall("glab", "label", "list", "--repo", "https://gitlab.com/o/r", "--per-page", "3"),
		},
		{
			...
			want:     wantCall("glab", "label", "create", "--repo", "https://gitlab.com/o/r", "--name", "bug"),
		},
		{
			...
			want:     wantCall("glab", "label", "create", "--repo", "https://gitlab.com/o/r", "--name", "bug", "--color", "#FF0000", "--description", "broken"),
		},
		{
			...
			want:     wantCall("glab", "label", "create", "--repo", "https://gitlab.com/custom/repo", "--name", "bug"),
		},
	}
...
func TestE2ETeaLabelListCreateArgv(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			args:   []string{"label", "list"},
			want:   wantTeaCall("labels", "list", "--login", "pub", "--repo", "o/r"),
		},
		{
			name:   "tea label list with limit",
			remote: "https://gitea.com/o/r.git",
			args:   []string{"label", "list", "--limit", "5"},
			want:   wantTeaCall("labels", "list", "--login", "pub", "--repo", "o/r", "--limit", "5"),
		},
		{
			name:   "tea label create minimal",
			remote: "https://gitea.com/o/r.git",
			args:   []string{"label", "create", "--name", "bug"},
			want:   wantTeaCall("labels", "create", "--login", "pub", "--repo", "o/r", "--name", "bug"),
		},
		{
			name:   "tea label create full",
			remote: "https://gitea.com/o/r.git",
			args:   []string{"label", "create", "--name", "bug", "--color", "ff0000", "--description", "버그"},
			want:   wantTeaCall("labels", "create", "--login", "pub", "--repo", "o/r", "--name", "bug", "--color", "ff0000", "--description", "버그"),
		},
		{
			name:   "tea label create repo flag",
			remote: "https://gitea.com/o/r.git",
			args:   []string{"--repo", "https://gitea.com/custom/repo", "label", "create", "--name", "bug"},
			want:   wantTeaCall("labels", "create", "--login", "pub", "--repo", "custom/repo", "--name", "bug"),
		},
	}
